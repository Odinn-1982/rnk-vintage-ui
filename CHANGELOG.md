...
### Changed
- Added: Package.json with Vitest and ESLint configuration
- Enhanced: RNK™ standards compliance
- Confirmed: All files comply with 500 LOC limit

## [1.2.1] - 2026-01-10

### Changed
- Updated module manifest for GitHub releases distribution
- Module now available as free download from GitHub
